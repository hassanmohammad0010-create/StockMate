...
class RefillRequestsPageData {
  final List<RefillRequestItem2> items;
  final int total;
  final int page;
  final int limit;
  ...
  factory RefillRequestsPageData.fromJson(Map<String, dynamic> json) {
    return RefillRequestsPageData(
      items: (json['items'] as List<dynamic>? ?? [])
          .map((e) => RefillRequestItem2.fromJson(e as Map<String, dynamic>))
          .toList(),
...
class RefillRequestItem2 {
  ...
  factory RefillRequestItem2.fromJson(Map<String, dynamic> json) {
