...
class InventoryDetailsPage extends StatelessWidget {
  InventoryDetailsPage({super.key, required this.item});
  MaterialItem item;
              ...
              CustomDialog.show(
                ...
                onConfirm: () {
                  ...
                  CustomDialog.show(
                    ...
                    message:
                        error ??
                        'تمت إضافة $quantity من ${item.name} الى السلة.',
                    showCancel: false,
                  );
                },
              );
...
// import 'package:stock_mate_project/Controller/App/Material_Info_Controller.dart';
// import 'package:stock_mate_project/core/models/Material_Model.dart';
// import 'package:stock_mate_project/core/utils/Shared_Widget/Add_To_Cart_Button.dart';
// import 'package:stock_mate_project/core/utils/Shared_Widget/Batch_Status_Row.dart';
// import 'package:stock_mate_project/core/utils/Shared_Widget/Batches_Card.dart';
// import 'package:stock_mate_project/core/utils/Shared_Widget/Custom_Back_Container.dart';
// import 'package:stock_mate_project/core/utils/Shared_Widget/Inventory_Quantity_Card.dart';
// import 'package:stock_mate_project/core/utils/Shared_Widget/Item_Info_Card.dart';
...
//                       context.screenHeight * 0.02,
//                     ),
//                     child: BatchesCard(item: item, controller: controller),
//                   ),
//                 ],
//               ),
//             ),
//           ),
//           AddToCartButton(item: item, controller: controller),
//           SizedBox(height: context.screenHeight * 0.02),
//         ],
//       ),
//     );
