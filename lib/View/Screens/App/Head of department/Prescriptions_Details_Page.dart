...
class PrescriptionDetailsPage extends StatelessWidget {
  ...
  Color _statusColor(PrescriptionStatus s) {
    switch (s) {
      case PrescriptionStatus.newRx:      return constBlue;
      case PrescriptionStatus.processed:  return const Color(0xFF09C05E);
      case PrescriptionStatus.rejected:   return const Color(0xFFFF2125);
    }
  }

  String _statusLabel(PrescriptionStatus s) {
    switch (s) {
      case PrescriptionStatus.newRx:      return 'جديدة';
      case PrescriptionStatus.processed:  return 'مُصرَّفة';
      case PrescriptionStatus.rejected:   return 'مرفوضة';
    }
  }
              ...
              child: Column(
                ...
                children: [
                      ...
                      children: [
                        ...
                        if (rx.notes.isNotEmpty) ...[
                          ...
                          _InfoRow(
                            ...
                            label: 'ملاحظات',
                            value: rx.notes,
                            valueColor: const Color(0xFFFF2125),
                          ),
                        ],
                      ],
                    ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.medication_outlined, color: constBlue, size: 20),
